...
class BuscapeCorpusReader(object):
    ...
    def __build_corpus(self, folder_path):
        ...
        for file_name in files:
            ...
            fin.close()
            #print self.__corpus[product_name]
    ...
    def get_data_sentence(self, product_name, id_review, id_sentence):
        ...
        annotations = []
        #print self.__corpus[product_name][id_review]['sentences'][id_sentence]['aspects']
...
if __name__ == '__main__':
    ...
    #m = re.findall("\[([^\]_\[]+)\]_\[(AI{0,1}\d+),(\+|-)\]", "[Ele é maravilhoso]_[A0,-], [um computador de bolso]_[A1,+], [vale muito a pena comprá-lo]_[A2,+].   e é [muito ruim]_[AI0,+] mesmo")
    #print m  